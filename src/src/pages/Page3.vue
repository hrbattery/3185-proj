  ...
  <v-app id="inspire">
    ...
    <v-main>
      ...
      <h1>
        ...
        <p>
            Neural Style Transfer - Wikipedia<br>
            A brief introduction to neural style transfer<br>
            Machine learning explained with gifs: Style transfer<br>
        </p>
        <h5>Tutorials</h5>
        <p>
            Neural Style Transfer with PyTorch<br>
            Real-time style transfer for iOS<br>
            On-device style transfer for Android<br>
            Style Transfer in Real-Time<br>
            Implementing Neural Style Transfer Using TensorFlow 2.0<br>
            Convolutional neural networks for artistic style transfer<br>
        </p>
        <h5>Literature review</h5>
        <p>
            Neural Style Transfer: A Review<br>
            [GitHub] ycjing / Neural-Style-Transfer-Papers<br>
            Papers with Code: Style Transfer<br>
        </p>
